...
var data = [
    {
        blog_image: "https://lh3.googleusercontent.com/a-/AOh14GhH48_pT8f_znuzSmntzDmPLhhCaipxE1uXMG8d=s96-c",
        ...
        user_auth: "google-oauth2|106967827403955011291"
    },
    {
        blog_image: "https://lh3.googleusercontent.com/a-/AOh14GhH48_pT8f_znuzSmntzDmPLhhCaipxE1uXMG8d=s96-c",
        blog_date: "2022-02-20",
        ...
        blog_content: "It can be used to find an element in a sorted array in O(logN) time where N is the number of elements in the sorted array. We can perform binary search on the range [0,n]. At each step of the algorithm, we have the size of the remaining range or we already finish.",
        user_auth: "google-oauth2|106967827403955011291"
    },
    {
        blog_image: "https://lh3.googleusercontent.com/a-/AOh14GhH48_pT8f_znuzSmntzDmPLhhCaipxE1uXMG8d=s96-c",
    ...
    },
    {
        ...
        blog_content: "Searching Algorithms are designed to retrieve an element from any data structure where it is used. A Sorting Algorithm is used to arranging the data of list or array into some specific order.",
        user_auth: "google-oauth2|106967827403955011291"
    },
    {
        blog_image: "https://lh3.googleusercontent.com/a-/AOh14GhH48_pT8f_znuzSmntzDmPLhhCaipxE1uXMG8d=s96-c",
        ...
        blog_content: "Before my 1st line of code (exctly 1 week and 1 day ago from today) i was like... 'cool, i have a project idea, now what' so i stared at my screen for like half a day, then started walking around my room thinking of how to start. I kinda just told myself lets make 1 component (stay tuned for part 2)",
        user_auth: "google-oauth2|106967827403955011291"
    },
    {
        blog_image: "https://lh3.googleusercontent.com/a-/AOh14GhH48_pT8f_znuzSmntzDmPLhhCaipxE1uXMG8d=s96-c",
